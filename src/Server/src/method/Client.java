        ...
        try {
            ...
            while (true) {
                ...
                if (status.equals("New")) {
                    ...
                    profile = ms.getImage();
                    Connection.getTxt().append("New Client name : " + userName + " has connected ...\n");
                    ...
                    int fileID = Connection.getFileID();
            ...
            try {
                Connection.getClients().remove(this);
                Connection.getTxt().append("Client Name : " + userName + " has been out of this server ...\n");
                for (Client s : Connection.getClients()) {
                ...
                Connection.getTxt().append("Error : " + e1);
            }
        }
    }
