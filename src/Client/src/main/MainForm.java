...
import swing.Get_Box;
import swing.Friend_Box;
import swing.Get_Box_New;
import swing.Get_File;
import swing.Get_File_New;
import swing.Get_Photo_Box;
import swing.Get_Photo_Box_New;
import swing.Send_Box;
import swing.Send_Box_New;
import swing.Send_File;
import swing.Send_File_New;
import swing.Send_Photo_Box;
import swing.Send_Photo_Box_New;
...
//        setIconImage(new ImageIcon(getClass().getResource("/icon/icon.png")).getImage());
    ...
    private void initComponents() {
        ...
        panel = new swing.Panel();
        cmdPhoto = new swing.Button();
        cmdEmoji = new swing.Button();
        cmdFile = new swing.Button();
        cmdMicro = new swing.Button();
        popUp_emoji = new javax.swing.JPopupMenu();
        panel_emoji = new swing.Panel();
        ...
        jLabel1.setText("MEMBER ONLINE");

        jLabel2.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 102, 102));
        jLabel2.setText("GROUP CHAT APPLICATION");
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/photo.png"))); // NOI18N
        ...
        panel_bgLayout.setHorizontalGroup(
            ...
            .addGroup(panel_bgLayout.createSequentialGroup()
                .addGap(44, 44, 44)
                .addComponent(txt, javax.swing.GroupLayout.PREFERRED_SIZE, 402, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(38, 38, 38)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_bgLayout.createSequentialGroup()
                ...
                .addComponent(lbStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 195, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(545, 545, 545))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_bgLayout.createSequentialGroup()
                .addComponent(spChat, javax.swing.GroupLayout.PREFERRED_SIZE, 638, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 71, Short.MAX_VALUE)
                .addComponent(spFriend, javax.swing.GroupLayout.PREFERRED_SIZE, 231, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
                ...
                .addGroup(panel_bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(panel_bgLayout.createSequentialGroup()
                        .addGroup(panel_bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(spChat, javax.swing.GroupLayout.DEFAULT_SIZE, 288, Short.MAX_VALUE)
                    ...
                    .addComponent(cmdSend, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
...
//        Method.getRecoder().captureAudio();
    ...
    private swing.Button cmdEmoji;
    private swing.Button cmdFile;
    private swing.Button cmdMicro;
    private javax.swing.JButton cmdMix;
    private swing.Button cmdPhoto;
    ...
    private swing.Panel panelMix;
    private javax.swing.JPanel panel_bg;
    private swing.Panel panel_emoji;
